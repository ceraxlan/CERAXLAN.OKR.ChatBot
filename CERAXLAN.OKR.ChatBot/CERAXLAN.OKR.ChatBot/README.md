...
- In a terminal, navigate to `CERAXLAN.OKR.ChatBot`

    ```bash
    # change into project folder
    cd CERAXLAN.OKR.ChatBot
    ```
...
- Run the bot from a terminal or from Visual Studio, choose option A or B.
  ...
  - Navigate to `CERAXLAN.OKR.ChatBot` folder
  - Select `CERAXLAN.OKR.ChatBot.csproj` file
